# ThinkPad-EFI
OpenCore EFI for the Lenovo ThinkPad L15 Gen 1 (AMD)

![macOS 26 on ThinkPad L15]([https://github.com/prodbyeternal/ThinkPad-EFI/blob/main/Tahoe.png?raw=true](https://github.com/ThinkDifferentInc/ThinkPad-AMD/blob/main/TD-Tahoe2601.png?raw=true))

This repository contains an OpenCore EFI configuration made to run **macOS Catalina up to Tahoe** on the **ThinkPad L15 Gen 1 (AMD)**.  
